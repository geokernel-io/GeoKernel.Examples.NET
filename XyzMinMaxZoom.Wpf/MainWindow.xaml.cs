...
public sealed partial class MainWindow
{
    ...
    private void LoadSample()
    {
        ...
        try
        {
            ...
            statusText.Text = "XyzMinMaxZoom loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusText.Text = "XyzMinMaxZoom failed.";
            MessageBox.Show(this, ex.Message, "XyzMinMaxZoom", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
