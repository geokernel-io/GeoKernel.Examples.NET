...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        mainLayout.Controls.Add(viewerControl, 0, 0);
        ...
        viewerControl.Margin = Padding.Empty;
        ...
        schemaGrid.Columns.Add("field", "Field");
        schemaGrid.Columns.Add("type", "Type");
        schemaGrid.Columns.Add("length", "Length");
        schemaGrid.Columns.Add("decimals", "Decimals");
