...
public sealed partial class MainForm : Form
{
    ...
    private static readonly string SampleName = "ShapefileLoad";
    ...
    {
        _samplePath = await SampleData.EnsureFileAsync("world_4326.zip", "world_4326", "world_4326.shp", "World shapefile", this, CreateSampleProgress());
    ...
    private void LoadSample()
    {
        ...
        var details = new List<string> { "ShapefileLoad sample", "", "API", ApiText(), "" };
        try
        {
            RunSample(details);
            details.Add("");
            ...
            statusLabel.Text = "ShapefileLoad loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusLabel.Text = "ShapefileLoad failed.";
            MessageBox.Show(this, ex.Message, "ShapefileLoad", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
