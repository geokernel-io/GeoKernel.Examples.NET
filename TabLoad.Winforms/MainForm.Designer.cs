...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        mainLayout = new TableLayoutPanel(); viewerControl = new GeoKernel.NET.WinForms.GeoKernelViewerControl();
        rightLayout = new TableLayoutPanel(); detailsTextBox = new TextBox();
        schemaGrid = new DataGridView(); attributesGrid = new DataGridView();
        statusStrip = new StatusStrip(); statusLabel = new ToolStripStatusLabel();
        downloadProgressBar = new ToolStripProgressBar();
        mainLayout.SuspendLayout(); rightLayout.SuspendLayout();
        ...
        statusLabel.Text = "Preparing MapInfo TAB sample data...";
        ...
        Name = "MainForm"; StartPosition = FormStartPosition.CenterScreen; Text = "TabLoad";
        Shown += MainForm_Shown;
        mainLayout.ResumeLayout(false); rightLayout.ResumeLayout(false); rightLayout.PerformLayout();
        ((System.ComponentModel.ISupportInitialize)schemaGrid).EndInit();
