...
public sealed partial class MainForm : Form
{
    ...
    private static readonly string SampleName = "GeoPackageLoad";
    ...
    {
        _samplePath = await SampleData.EnsureFileAsync("europe_detailed.zip", "europe_detailed", "europe_detailed.gpkg", "Europe GeoPackage", this, CreateSampleProgress());
    ...
    private void LoadSample()
    {
        ...
        var details = new List<string> { "GeoPackageLoad sample", "", "API", ApiText(), "" };
        try
        {
            RunSample(details);
            details.Add("");
            ...
            statusLabel.Text = "GeoPackageLoad loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusLabel.Text = "GeoPackageLoad failed.";
            MessageBox.Show(this, ex.Message, "GeoPackageLoad", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
    ...
    private void RunSample(List<string> details)
    {
        switch (SampleKind)
        {
            ...
            case "labelCollision":
                ...
                break;
            default:
                AddFile(details, "europe_detailed.gpkg", null);
                break;
        }
    }
