...
public partial class MainWindow : Window
{
    ...
    private void LoadLayers()
    {
        ...
        AddLayer(Path.Combine(root, "assets", "data", "world_4326.shp"), "World", new GeoKernelLayerStyle
        {
            FillColor = "#D8E5E1",
            FillOpacity = 220,
            LineColor = "#7B918D",
        ...
        AddLayer(Path.Combine(root, "assets", "data", "us_state_boundaries.shp"), "States", new GeoKernelLayerStyle
        {
            FillColor = "#A9C8DB",
            FillOpacity = 115,
            LineColor = "#356780",
        ...
        AddLayer(Path.Combine(root, "assets", "data", "usa_cities_4326.kml"), "Cities", new GeoKernelLayerStyle
        {
            PointColor = "#D95D39",
            PointSize = 7.0,
            LineColor = "#D95D39",
