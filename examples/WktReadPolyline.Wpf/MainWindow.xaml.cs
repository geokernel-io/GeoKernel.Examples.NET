...
public partial class MainWindow
{
    ...
    private void ReadLineString_Click(object sender, RoutedEventArgs e) => ParseAndRender();
    ...
    private void ParseAndRender()
    {
        ...
        try
        {
            var lonLatPoints = viewerControl.ReadWktLineString(input);
            ...
            viewerControl.AddPolylineLayer("WKT LineString", webMercatorPoints, LineStyle());
            viewerControl.ViewExtent = viewExtent;

            detailsTextBox.Text = DetailsText(input, lonLatPoints, viewExtent);
            statusText.Text = $"GisWktReader::readLineString parsed {lonLatPoints.Count} vertices.";
        }
