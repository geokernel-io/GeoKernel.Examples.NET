...
namespace GeoKernel.XyzAttribution.Wpf;
...
public sealed partial class MainWindow
{
    ...
    private void LoadSample()
    {
        ...
        try
        {
            ...
            statusText.Text = "XyzAttribution loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusText.Text = "XyzAttribution failed.";
            MessageBox.Show(this, ex.Message, "XyzAttribution", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
