...
partial class MainForm
{
    ...
    private Button runRelateButton;
    ...
    private void InitializeComponent()
    {
        ...
        toolbarPanel.Controls.AddRange(new Control[] { fullExtentButton, operationLabel, runRelateButton });
        ...
        operationLabel.Size = new Size(185, 22);
        operationLabel.Text = "Operation: Relate(left, right)";
        // 
        // runRelateButton
        // 
        runRelateButton.Name = "runRelateButton";
        runRelateButton.AutoSize = true;
        runRelateButton.Height = 28;
        runRelateButton.Margin = new Padding(0, 2, 4, 2);
        runRelateButton.Padding = new Padding(8, 0, 8, 0);
        runRelateButton.UseVisualStyleBackColor = true;
        runRelateButton.Size = new Size(70, 22);
        runRelateButton.Text = "Run Relate";
        runRelateButton.Click += runRelateButton_Click;
        // 
        // splitContainer
        // 
        ...
        detailsTextBox.Size = new Size(296, 633);
