...
public sealed partial class MainWindow
{
    ...
    private void LoadSample()
    {
        ...
        try
        {
            ...
            statusText.Text = "XyzPresets loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusText.Text = "XyzPresets failed.";
            MessageBox.Show(this, ex.Message, "XyzPresets", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
