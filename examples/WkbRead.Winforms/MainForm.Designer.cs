...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        inputPanel.Controls.Add(wkbLabel);
        inputPanel.Controls.Add(wkbTextBox);
        ...
        modeComboBox.Items.AddRange(new object[] { "Point", "LineString", "Polygon", "MultiPolygon" });
        modeComboBox.Location = new Point(55, 5);
        modeComboBox.Name = "modeComboBox";
        modeComboBox.Size = new Size(118, 23);
        modeComboBox.TabIndex = 1;
        modeComboBox.SelectedIndexChanged += modeComboBox_SelectedIndexChanged;
        wkbLabel.AutoSize = true;
        wkbLabel.Location = new Point(181, 9);
        wkbLabel.Name = "wkbLabel";
        wkbLabel.Size = new Size(35, 15);
        wkbLabel.TabIndex = 2;
        wkbLabel.Text = "WKB:";
        wkbTextBox.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
        wkbTextBox.Location = new Point(222, 5);
        wkbTextBox.Name = "wkbTextBox";
        wkbTextBox.Size = new Size(672, 23);
        wkbTextBox.TabIndex = 3;
        wkbTextBox.KeyDown += wkbTextBox_KeyDown;
