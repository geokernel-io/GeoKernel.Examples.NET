...
namespace GeoKernel.XyzMinMaxZoom.Winforms;

public sealed partial class MainForm : Form
{
    private static readonly string SampleName = "XyzMinMaxZoom";
    ...
    private void LoadSample()
    {
        ...
        var details = new List<string> { "XyzMinMaxZoom sample", "", "API", ApiText(), "" };
        try
        {
            RunSample(details);
            details.Add("");
            ...
            statusLabel.Text = "XyzMinMaxZoom loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusLabel.Text = "XyzMinMaxZoom failed.";
            MessageBox.Show(this, ex.Message, "XyzMinMaxZoom", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
