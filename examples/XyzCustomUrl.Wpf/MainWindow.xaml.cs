...
public sealed partial class MainWindow
{
    ...
    private void LoadSample()
    {
        ...
        try
        {
            ...
            statusText.Text = "XyzCustomUrl loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusText.Text = "XyzCustomUrl failed.";
            MessageBox.Show(this, ex.Message, "XyzCustomUrl", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
