...
public sealed partial class MainForm : Form
{
    ...
    private void LoadSample()
    {
        ...
        try
        {
            ...
            statusLabel.Text = "RasterWorldTransform loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusLabel.Text = "RasterWorldTransform failed.";
            MessageBox.Show(this, ex.Message, "RasterWorldTransform", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
