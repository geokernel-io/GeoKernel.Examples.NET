...
{
    private static readonly string SampleName = "LabelCollisionOff";
    private static readonly string SampleKind = "labelCollision";
    public MainForm()
    {
        InitializeComponent();
    }
    ...
    private void LoadSample()
    {
        ...
        var details = new List<string> { "LabelCollisionOff sample", "", "API", ApiText(), "" };
        try
        {
            RunSample(details);
            details.Add("");
            ...
            statusLabel.Text = "LabelCollisionOff loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusLabel.Text = "LabelCollisionOff failed.";
            MessageBox.Show(this, ex.Message, "LabelCollisionOff", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
