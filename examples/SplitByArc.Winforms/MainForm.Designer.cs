...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        toolbarPanel.Controls.AddRange(new Control[] { fullExtentButton, operationLabel, runSplitButton });
        ...
        operationLabel.Size = new Size(203, 22);
        operationLabel.Text = "Operation: SplitByArc(polygon, line)";
        // 
        // runSplitButton
        // 
        runSplitButton.Name = "runSplitButton";
        runSplitButton.AutoSize = true;
        runSplitButton.Height = 28;
        runSplitButton.Margin = new Padding(0, 2, 4, 2);
        runSplitButton.Padding = new Padding(8, 0, 8, 0);
        runSplitButton.UseVisualStyleBackColor = true;
        runSplitButton.Size = new Size(93, 22);
        runSplitButton.Text = "Run SplitByArc";
        runSplitButton.Click += runSplitButton_Click;
        // 
        // splitContainer
        // 
