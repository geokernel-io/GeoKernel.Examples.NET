...
namespace GeoKernel.OpenStreetMap.Wpf;
...
public sealed partial class MainWindow
{
    ...
    private void LoadSample()
    {
        ...
        try
        {
            ...
            statusText.Text = "OpenStreetMap loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusText.Text = "OpenStreetMap failed.";
            MessageBox.Show(this, ex.Message, "OpenStreetMap", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
