...
public sealed partial class MainForm : Form
{
    ...
    private void RenderScene()
    {
        ...
        else
        {
            ...
            var layerIndex = geoKernelViewerControl.AddFixedPolylineLayer(
    ...
    {
        geoKernelViewerControl.AddPolylineLayer("Source valid line parts", [SourceParts[0], SourceParts[3]], SourceStyle());
        geoKernelViewerControl.AddPointLayer("Source invalid short parts", [SourceParts[1][0], SourceParts[2][0]], InvalidPointStyle());
    }
