...
public sealed partial class MainWindow
{
    ...
    private void LoadSample()
    {
        ...
        try
        {
            ...
            statusText.Text = "RasterTileCache loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusText.Text = "RasterTileCache failed.";
            MessageBox.Show(this, ex.Message, "RasterTileCache", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
