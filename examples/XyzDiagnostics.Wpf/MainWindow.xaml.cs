...
public sealed partial class MainWindow
{
    ...
    private void LoadSample()
    {
        ...
        try
        {
            ...
            statusText.Text = "XyzDiagnostics loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusText.Text = "XyzDiagnostics failed.";
            MessageBox.Show(this, ex.Message, "XyzDiagnostics", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
