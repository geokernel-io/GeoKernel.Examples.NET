...
namespace GeoKernel.ExtentOperations.Wpf;
...
public partial class MainWindow
{
    ...
    private void RenderScene()
    {
        ...
        viewerControl.AddPolygonLayer("A.expand(B)", ExtentRing(expanded), ExpandedStyle());
        viewerControl.AddPolygonLayer("A.inflate(0.9, 0.7)", ExtentRing(inflated), InflatedStyle());
        viewerControl.AddPolygonLayer("A", ExtentRing(BaseExtent), BaseStyle());
        viewerControl.AddPolygonLayer("B", ExtentRing(OtherExtent), OtherStyle());
        viewerControl.AddPointLayer("A contains inside point", [InsidePoint], InsidePointStyle());
        viewerControl.AddPointLayer("A contains outside point", [OutsidePoint], OutsidePointStyle());
        ...
        statusText.Text = "Extent operations rendered.";
    }

    private void SetSampleExtent()
    {
        viewerControl.ViewExtent = new GeoKernelExtent(-5.8, -3.0, 5.4, 3.6);
    }
