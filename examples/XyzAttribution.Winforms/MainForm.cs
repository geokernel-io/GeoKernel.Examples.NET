...
namespace GeoKernel.XyzAttribution.Winforms;

public sealed partial class MainForm : Form
{
    private static readonly string SampleName = "XyzAttribution";
    ...
    private void LoadSample()
    {
        ...
        var details = new List<string> { "XyzAttribution sample", "", "API", ApiText(), "" };
        try
        {
            RunSample(details);
            details.Add("");
            ...
            statusLabel.Text = "XyzAttribution loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusLabel.Text = "XyzAttribution failed.";
            MessageBox.Show(this, ex.Message, "XyzAttribution", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
