...
public sealed partial class MainForm : Form
{
    ...
    private bool LoadLayer()
    {
        ...
        if (worldLayer is not null)
            geoKernelViewerControl.SetLayerName(worldLayer.Index, "World source - EPSG:3857");
    ...
    private static string WebMercatorDetails()
    {
        return string.Join(
            ...
            "geoKernelViewerControl.AddLayerFile(\"world_3857.shp\", options)",
            "geoKernelViewerControl.ViewExtent = WebMercator full world extent",
            "",
