...
public sealed partial class MainWindow
{
    ...
    private void LoadSample()
    {
        ...
        try
        {
            ...
            statusText.Text = "LabelCollisionOff loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusText.Text = "LabelCollisionOff failed.";
            MessageBox.Show(this, ex.Message, "LabelCollisionOff", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
