...
public sealed partial class MainForm : Form
{
    ...
    private void RenderScene(bool showHull)
    {
        ...
        geoKernelViewerControl.AddPolygonLayer("Left Polygon", LeftPolygon, LeftStyle());
        geoKernelViewerControl.AddPolygonLayer("Right Polygon", RightPolygon, RightStyle());
        ...
        if (showHull)
        {
            var resultLayerIndex = geoKernelViewerControl.AddPolygonConvexHullTwoLayer(
                "Convex Hull",
                LeftPolygon,
                RightPolygon,
                HullStyle());
