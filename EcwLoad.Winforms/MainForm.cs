...
public sealed partial class MainForm : Form
{
    ...
    private static readonly string SampleName = "EcwLoad";
    ...
    {
        _rasterPath = await SampleData.EnsureFileAsync("world_8km_ecw.zip", "world_8km_ecw", "world_8km.ecw", "World ECW", this, CreateSampleProgress());
    ...
    private void LoadSample()
    {
        ...
        var details = new List<string> { "EcwLoad sample", "", "API", ApiText(), "" };
        try
        {
            RunSample(details);
            details.Add("");
            ...
            statusLabel.Text = "EcwLoad loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusLabel.Text = "EcwLoad failed.";
            MessageBox.Show(this, ex.Message, "EcwLoad", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
    ...
    private void RunSample(List<string> details)
    {
        switch (SampleKind)
        {
            ...
            case "labelCollision":
                ...
                break;
            default:
                AddFile(details, "world_8km.ecw", null);
                break;
        }
    }
    ...
    private string DataPath(string relativePath) => relativePath.Equals("world_8km.ecw", StringComparison.OrdinalIgnoreCase) ? _rasterPath : relativePath;
