...
public sealed partial class MainForm : Form
{
    ...
    private void SeedAttributes()
    {
        ...
        try
        {
            foreach (var pair in _sites)
                geoKernelViewerControl.SetShapeAttributesInEditLayer(_layerIndex, pair.Key, ToAttributes(pair.Value));
    ...
    private void applyButton_Click(object sender, EventArgs e)
    {
        ...
        if (!geoKernelViewerControl.SetShapeAttributesInEditLayer(_layerIndex, _selectedShapeId, ToAttributes(state)))
        {
