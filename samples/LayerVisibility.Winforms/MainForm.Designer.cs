...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        sidePanelLayout.Controls.Add(visibilityButton, 0, 1);
        ...
        layerListBox.Size = new Size(204, 681);
        layerListBox.TabIndex = 0;
        layerListBox.SelectedIndexChanged += layerListBox_SelectedIndexChanged;
        // 
        // visibilityButton
        // 
        visibilityButton.Dock = DockStyle.Fill;
        visibilityButton.Location = new Point(8, 697);
        visibilityButton.Margin = new Padding(0);
        visibilityButton.Name = "visibilityButton";
        visibilityButton.Size = new Size(204, 32);
