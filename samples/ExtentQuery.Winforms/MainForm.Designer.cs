...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        selectButton.Padding = new Padding(8, 0, 8, 0);
        selectButton.UseVisualStyleBackColor = true;
        selectButton.Size = new Size(103, 22);
        selectButton.Text = "Run Extent Query";
        ...
        toolStateLabel.Size = new Size(212, 22);
        toolStateLabel.Text = "API: hitTestFeaturesInExtent(extent)";
        // 
        // mainSplitContainer
        // 
        ...
        geoKernelViewerControl.Size = new Size(824, 714);
        ...
        rightSplitContainer.Size = new Size(356, 714);
