...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        zoomToSelectionButton.AutoSize = true;
        zoomToSelectionButton.Height = 28;
        zoomToSelectionButton.Margin = new Padding(0, 3, 4, 3);
        zoomToSelectionButton.Padding = new Padding(8, 0, 8, 0);
        zoomToSelectionButton.UseVisualStyleBackColor = true;
        zoomToSelectionButton.Size = new Size(109, 22);
        zoomToSelectionButton.Text = "Zoom To Selection";
