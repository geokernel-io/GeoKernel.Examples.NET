...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        hitTestButton.AutoSize = true;
        hitTestButton.Height = 28;
        hitTestButton.Margin = new Padding(0, 3, 4, 3);
        hitTestButton.Padding = new Padding(8, 0, 8, 0);
        hitTestButton.TextAlign = ContentAlignment.MiddleCenter;
        hitTestButton.UseVisualStyleBackColor = true;
        hitTestButton.Size = new Size(79, 22);
        hitTestButton.Text = "Click Hit Test";
        ...
        toolStateLabel.Size = new Size(150, 22);
