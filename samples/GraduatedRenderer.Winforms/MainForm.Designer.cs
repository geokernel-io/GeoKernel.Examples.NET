...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        // classColumn
        // 
        classColumn.Text = "POPULATION classes";
        classColumn.Width = 235;
        // 
        // legendImageList
        // 
        legendImageList.ColorDepth = ColorDepth.Depth32Bit;
        legendImageList.ImageSize = new Size(38, 22);
        legendImageList.TransparentColor = Color.Transparent;
        // 
        // controlPanel
        // 
        controlPanel.Controls.Add(rampComboBox);
        controlPanel.Controls.Add(rampLabel);
        ...
        // rampComboBox
        // 
        rampComboBox.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
        rampComboBox.DropDownStyle = ComboBoxStyle.DropDownList;
        rampComboBox.FormattingEnabled = true;
        rampComboBox.Location = new Point(8, 28);
        rampComboBox.Name = "rampComboBox";
        rampComboBox.Size = new Size(229, 23);
        rampComboBox.TabIndex = 1;
        rampComboBox.SelectedIndexChanged += rampComboBox_SelectedIndexChanged;
        // 
        // rampLabel
        // 
        rampLabel.AutoSize = true;
        rampLabel.Location = new Point(8, 8);
        rampLabel.Name = "rampLabel";
        rampLabel.Size = new Size(67, 15);
        rampLabel.TabIndex = 0;
        rampLabel.Text = "Color ramp";
        // 
