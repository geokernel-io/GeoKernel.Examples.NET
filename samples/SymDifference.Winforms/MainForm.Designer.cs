...
partial class MainForm
{
    ...
    private Button runSymDifferenceButton;
    ...
    private void InitializeComponent()
    {
        ...
        runSymDifferenceButton = new Button();
        ...
        toolbarPanel.Controls.AddRange(new Control[] { fullExtentButton, operationLabel, runSymDifferenceButton });
        ...
        operationLabel.Size = new Size(245, 22);
        operationLabel.Text = "Operation: SymmetricalDifference(left, right)";
        // 
        // runSymDifferenceButton
        // 
        runSymDifferenceButton.Name = "runSymDifferenceButton";
        runSymDifferenceButton.AutoSize = true;
        runSymDifferenceButton.Height = 28;
        runSymDifferenceButton.Margin = new Padding(0, 2, 4, 2);
        runSymDifferenceButton.Padding = new Padding(8, 0, 8, 0);
        runSymDifferenceButton.UseVisualStyleBackColor = true;
        runSymDifferenceButton.Size = new Size(111, 22);
        runSymDifferenceButton.Text = "Run Sym Difference";
        runSymDifferenceButton.Click += runSymDifferenceButton_Click;
        // 
        // splitContainer
        // 
