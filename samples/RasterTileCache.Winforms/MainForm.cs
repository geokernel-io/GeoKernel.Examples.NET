...
{
    private static readonly string SampleName = "RasterTileCache";
    private static readonly string SampleKind = "rasterTileCache";
    public MainForm()
    {
        InitializeComponent();
    }
    ...
    private void LoadSample()
    {
        ...
        var details = new List<string> { "RasterTileCache sample", "", "API", ApiText(), "" };
        try
        {
            RunSample(details);
            details.Add("");
            ...
            statusLabel.Text = "RasterTileCache loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusLabel.Text = "RasterTileCache failed.";
            MessageBox.Show(this, ex.Message, "RasterTileCache", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
