...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        toolbarPanel.Controls.AddRange(new Control[] { fullExtentButton, operationLabel, runHullButton });
        ...
        operationLabel.Size = new Size(169, 22);
        operationLabel.Text = "Operation: ConvexHull(shape)";
        // 
        // runHullButton
        // 
        runHullButton.Name = "runHullButton";
        runHullButton.AutoSize = true;
        runHullButton.Height = 28;
        runHullButton.Margin = new Padding(0, 2, 4, 2);
        runHullButton.Padding = new Padding(8, 0, 8, 0);
        runHullButton.UseVisualStyleBackColor = true;
        runHullButton.Size = new Size(100, 22);
        runHullButton.Text = "Run Convex Hull";
        runHullButton.Click += runHullButton_Click;
        // 
        // splitContainer
        // 
