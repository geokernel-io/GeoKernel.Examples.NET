...
public partial class MainWindow
{
    ...
    private void RunDifference_Click(object sender, RoutedEventArgs e)
    {
    ...
    private void RenderScene(bool showResult)
    {
        ...
        if (showResult)
        {
            var resultLayerIndex = viewerControl.AddPolygonDifferenceLayer(
                "Difference Result",
                PolygonA,
                PolygonB,
                ResultStyle());
        ...
        else
        {
            ...
            statusText.Text = "Source polygons are ready. Click Run Difference.";
        }
