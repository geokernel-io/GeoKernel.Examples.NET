...
public partial class MainWindow
{
    ...
    private void ViewerControl_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
    {
        ...
        AppendClickLog(position.X, position.Y, worldPoint, hit);
        UpdateStatus($"mapClicked: tool={viewerControl.ActiveTool} screen={PointText(position.X, position.Y)} world={PointText(worldPoint.X, worldPoint.Y)} modifiers={ModifiersText()}");
    }
