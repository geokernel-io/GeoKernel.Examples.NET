...
{
    private static readonly string SampleName = "XyzTileSize";
    ...
    private void LoadSample()
    {
        ...
        var details = new List<string> { "XyzTileSize sample", "", "API", ApiText(), "" };
        try
        {
            RunSample(details);
            details.Add("");
            ...
            statusLabel.Text = "XyzTileSize loaded.";
        }
        catch (Exception ex)
        {
            ...
            MessageBox.Show(this, ex.Message, "XyzTileSize", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
