...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        operationLabel.Size = new Size(207, 22);
        operationLabel.Text = "Operation: GetCrossings(left, right)";
        // 
        // runButton
        // 
        ...
        runButton.Height = 28;
        runButton.Margin = new Padding(0, 2, 4, 2);
        runButton.Padding = new Padding(8, 0, 8, 0);
        runButton.UseVisualStyleBackColor = true;
        runButton.Size = new Size(107, 22);
        runButton.Text = "Run GetCrossings";
