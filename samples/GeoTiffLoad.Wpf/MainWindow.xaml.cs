...
namespace GeoKernel.GeoTiffLoad.Wpf;

public sealed partial class MainWindow
{
    private static readonly string SampleName = "GeoTiffLoad";
    ...
    private void LoadSample()
    {
        ...
        var details = new List<string> { "GeoTiffLoad sample", "", "API", ApiText(), "" };
        try
        {
            RunSample(details);
            details.Add("");
            ...
            statusText.Text = "GeoTiffLoad loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusText.Text = "GeoTiffLoad failed.";
            MessageBox.Show(this, ex.Message, "GeoTiffLoad", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
