...
public sealed partial class MainWindow
{
    ...
    private void LoadSample()
    {
        ...
        try
        {
            ...
            statusText.Text = "GeoPackageLoad loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusText.Text = "GeoPackageLoad failed.";
            MessageBox.Show(this, ex.Message, "GeoPackageLoad", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
