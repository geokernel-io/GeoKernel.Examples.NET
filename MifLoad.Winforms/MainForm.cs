...
public sealed partial class MainForm : Form
{
    ...
    private static readonly string SampleName = "MifLoad";
    ...
    {
        _samplePath = await SampleData.EnsureFileAsync("albania.zip", "albania", "albania.mif", "Albania MIF", this, CreateSampleProgress());
    ...
    private void LoadSample()
    {
        ...
        var details = new List<string> { "MifLoad sample", "", "API", ApiText(), "" };
        try
        {
            RunSample(details);
            details.Add("");
            ...
            statusLabel.Text = "MifLoad loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusLabel.Text = "MifLoad failed.";
            MessageBox.Show(this, ex.Message, "MifLoad", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
    ...
    private void RunSample(List<string> details)
    {
        switch (SampleKind)
        {
            ...
            case "labelCollision":
                ...
                break;
            default:
                AddFile(details, "albania.mif", null);
                break;
        }
    }
