...
public sealed partial class MainForm : Form
{
    ...
    {
        var wasActive = geoKernelViewerControl.HasActiveEditSketch;
        geoKernelViewerControl.CancelEditSketch();
        BeginPolygonEditing();
        UpdateStatus(wasActive ? "Active edit sketch cancelled." : "There is no active edit sketch.");
    }
