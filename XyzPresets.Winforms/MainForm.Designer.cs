...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        localCacheCheckBox = new CheckBox();
        ...
        toolbarPanel.Controls.Add(presetLabel);
        toolbarPanel.Controls.Add(presetComboBox);
        toolbarPanel.Controls.Add(localCacheCheckBox);
        ...
        presetLabel.Location = new Point(194, 10);
        presetLabel.Text = "Preset:";
        presetComboBox.DropDownStyle = ComboBoxStyle.DropDownList;
        presetComboBox.Location = new Point(242, 6);
        presetComboBox.Size = new Size(260, 23);
        presetComboBox.SelectedIndexChanged += presetComboBox_SelectedIndexChanged;
        localCacheCheckBox.AutoSize = true;
        localCacheCheckBox.Checked = true;
        localCacheCheckBox.CheckState = CheckState.Checked;
        localCacheCheckBox.Location = new Point(514, 8);
        localCacheCheckBox.Text = "Local cache";
        localCacheCheckBox.CheckedChanged += localCacheCheckBox_CheckedChanged;
        ...
        statusLabel.Text = "XyzPresets ready.";
