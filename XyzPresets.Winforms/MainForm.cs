...
public sealed partial class MainForm : Form
{
    ...
    private void LoadSample()
    {
        ...
        var details = new List<string> { "XyzPresets sample", "", "API", ApiText(), "" };
        try
        {
            RunSample(details);
            details.Add("");
            ...
            statusLabel.Text = "XyzPresets loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusLabel.Text = "XyzPresets failed.";
            MessageBox.Show(this, ex.Message, "XyzPresets", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
