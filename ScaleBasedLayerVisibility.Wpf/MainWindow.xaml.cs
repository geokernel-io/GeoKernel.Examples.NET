...
public partial class MainWindow : Window
{
    ...
    private void LoadLayers()
    {
        AddLayer(
            "World",
            SampleData.EnsureKnownWpfSampleFile("world_4326.shp", this),
            WorldStyle(),
            minVisibleScale: 0.0,
        ...
        AddLayer(
            "States",
            SampleData.EnsureKnownWpfSampleFile("usa_states_3857.shp", this),
            StatesStyle(),
            minVisibleScale: 5.0,
        ...
        AddLayer(
            "Cities",
            SampleData.EnsureKnownWpfSampleFile("usa_cities.shp", this),
            CitiesStyle(),
