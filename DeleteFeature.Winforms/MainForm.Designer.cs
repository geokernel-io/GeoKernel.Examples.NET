...
partial class MainForm
{
    ...
    private ColumnHeader featureIdColumn;
    ...
    private void InitializeComponent()
    {
        ...
        featureIdColumn = new ColumnHeader();
        ...
        toolbarPanel.Controls.AddRange(new Control[] { selectButton, deleteFeatureButton, deleteSelectedButton, resetButton, fullExtentButton, countLabel });
        ...
        // deleteFeatureButton
        // 
        deleteFeatureButton.Name = "deleteFeatureButton";
        deleteFeatureButton.AutoSize = true;
        deleteFeatureButton.Height = 28;
        deleteFeatureButton.Margin = new Padding(0, 3, 4, 3);
        deleteFeatureButton.Padding = new Padding(8, 0, 8, 0);
        deleteFeatureButton.UseVisualStyleBackColor = true;
        deleteFeatureButton.Size = new Size(86, 22);
        deleteFeatureButton.Text = "Delete Feature";
        ...
        deleteSelectedButton.Height = 28;
        deleteSelectedButton.Margin = new Padding(0, 3, 4, 3);
        deleteSelectedButton.Padding = new Padding(8, 0, 8, 0);
        deleteSelectedButton.UseVisualStyleBackColor = true;
        deleteSelectedButton.Size = new Size(91, 22);
        ...
        resetButton.Size = new Size(75, 22);
        ...
        countLabel.Size = new Size(170, 22);
        ...
        // featureListView
        // 
        featureListView.Columns.AddRange(new ColumnHeader[] { featureIdColumn, nameColumn, groupColumn, valueColumn });
        ...
        featureListView.Location = new Point(0, 0);
        featureListView.MultiSelect = false;
        featureListView.Name = "featureListView";
        featureListView.Size = new Size(260, 714);
        ...
        // featureIdColumn
        // 
        featureIdColumn.Text = "Feature ID";
        featureIdColumn.Width = 65;
        // 
        // nameColumn
        // 
        ...
        geoKernelViewerControl.Size = new Size(920, 714);
