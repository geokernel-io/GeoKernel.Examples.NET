...
public sealed partial class MainForm : Form
{
    ...
    {
        // Qt renders this sample entirely with transient shapes. Keeping the
        // same path avoids rebuilding layer/full-extent state after a check.
        geoKernelViewerControl.ClearShapes();
        geoKernelViewerControl.AddPolygonShape(ValidPolygon, PolygonStyle("#BFD7EA", "#2F80C2"));
        geoKernelViewerControl.AddPolygonShape(SelfIntersectingPolygon, PolygonStyle("#F6D6AD", "#D95D39"));
        ...
        if (checkedShape)
        {
            ...
            geoKernelViewerControl.AddPolygonShape(ValidPolygon, CheckedStyle("#CDE7D8", "#2A9D8F"));
            geoKernelViewerControl.AddPolygonShape(SelfIntersectingPolygon, CheckedStyle("#F4A261", "#D62828"));
