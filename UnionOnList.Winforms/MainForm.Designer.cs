...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        toolbarPanel.Controls.AddRange(new Control[] { fullExtentButton, operationLabel, runUnionButton });
        ...
        operationLabel.Size = new Size(183, 22);
        operationLabel.Text = "Operation: UnionOnList(shapes)";
        runUnionButton.Name = "runUnionButton";
        runUnionButton.AutoSize = true;
        runUnionButton.Height = 28;
        runUnionButton.Margin = new Padding(0, 2, 4, 2);
        runUnionButton.Padding = new Padding(8, 0, 8, 0);
        runUnionButton.UseVisualStyleBackColor = true;
        runUnionButton.Size = new Size(101, 22);
        runUnionButton.Text = "Run UnionOnList";
        runUnionButton.Click += runUnionButton_Click;
