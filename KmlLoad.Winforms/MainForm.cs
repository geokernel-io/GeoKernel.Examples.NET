...
namespace GeoKernel.KmlLoad.Winforms;

public sealed partial class MainForm : Form
{
    private string _samplePath = string.Empty;
    private static readonly string SampleName = "KmlLoad";
    ...
    {
        _samplePath = await SampleData.EnsureFileAsync("travel.zip", "travel", "travel.kmz", "Travel KML", this, CreateSampleProgress());
    ...
    private void LoadSample()
    {
        ...
        var details = new List<string> { "KmlLoad sample", "", "API", ApiText(), "" };
        try
        {
            RunSample(details);
            details.Add("");
            ...
            statusLabel.Text = "KmlLoad loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusLabel.Text = "KmlLoad failed.";
            MessageBox.Show(this, ex.Message, "KmlLoad", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
    ...
    private void RunSample(List<string> details)
    {
        switch (SampleKind)
        {
            ...
            case "labelCollision":
                ...
                break;
            default:
                AddFile(details, "travel.kmz", null);
                break;
        }
    }
