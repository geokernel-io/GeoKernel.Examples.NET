...
public sealed partial class MainForm : Form
{
    ...
    private void geoKernelViewerControl_MapMouseUp(object? sender, GeoKernelMapMouseEventArgs e)
    {
        ...
        UpdateStatus($"mapClicked: tool={geoKernelViewerControl.ActiveTool} screen={PointText(e.ScreenPoint.X, e.ScreenPoint.Y)} world={PointText(worldPoint.X, worldPoint.Y)} modifiers={ModifiersText()}");
    }
    ...
    private void AppendClickLog(GeoKernelMapMouseEventArgs e, GeoKernelPoint worldPoint, GeoKernelFeatureHitTestResult? hit)
    {
        logGrid.Rows.Add(
            DateTime.Now.ToString("HH:mm:ss.fff"),
            geoKernelViewerControl.ActiveTool,
            PointText(e.ScreenPoint.X, e.ScreenPoint.Y),
