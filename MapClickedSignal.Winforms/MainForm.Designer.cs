...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        infoButton.BackgroundImage = (Image)resources.GetObject("infoButton.Image");
        infoButton.BackgroundImageLayout = ImageLayout.Center;
        infoButton.FlatStyle = FlatStyle.Flat;
        infoButton.FlatAppearance.BorderSize = 0;
        infoButton.TabStop = false;
        infoButton.AccessibleName = "Info";
        toolbarToolTip.SetToolTip(infoButton, "Info");
        ...
        infoButton.Size = new Size(36, 36);
        infoButton.Text = "";
