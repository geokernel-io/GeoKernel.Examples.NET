...
public partial class MainWindow
{
    ...
    private bool AddLayer(string key)
    {
        ...
        var path = SampleData.EnsureKnownWpfSampleFile(layer.FileName, this);
    ...
    private static bool MatchesLayer(GeoKernelLayerInfo? info, SampleLayer layer)
    {
        ...
        return !string.IsNullOrWhiteSpace(info.Path) &&
            string.Equals(Path.GetFileName(info.Path), layer.FileName, StringComparison.OrdinalIgnoreCase);
    }
    ...
    private sealed record SampleLayer(string Name, string FileName, GeoKernelLayerStyle Style);
}
