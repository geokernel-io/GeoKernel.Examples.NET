...
public partial class MainWindow
{
    ...
    {
        var selectedCount = e.SelectedFeatureCount;
        Dispatcher.BeginInvoke(() =>
        {
            AppendEvent("SelectionChanged", selectedCount, "Native viewer selectionChanged signal fired.");
            UpdateSelectionState($"SelectionChanged({selectedCount})", selectedCount);
        });
    }
    ...
    private void UpdateSelectionState(string text, int? selectedCount = null)
    {
        toolStateText.Text = $"Selected: {selectedCount ?? viewerControl.SelectedFeatureCount} | Signal: SelectionChanged";
