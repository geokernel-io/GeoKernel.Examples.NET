...
namespace GeoKernel.KmlLoad.Wpf;
...
public sealed partial class MainWindow
{
    ...
    private void LoadSample()
    {
        ...
        try
        {
            ...
            statusText.Text = "KmlLoad loaded.";
        }
        catch (Exception ex)
        {
            details.Add(ex.Message);
            detailsTextBox.Text = string.Join(Environment.NewLine, details);
            statusText.Text = "KmlLoad failed.";
            MessageBox.Show(this, ex.Message, "KmlLoad", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
