...
public partial class MainWindow
{
    ...
    private void RenderScene(bool showHull)
    {
        ...
        {
            viewerControl.RemoveLayer(_hullLayerIndex);
            _hullLayerIndex = -1;
        }

        viewerControl.ClearShapes();
        viewerControl.AddPolygonShape(LeftPolygon, LeftStyle());
        viewerControl.AddPolygonShape(RightPolygon, RightStyle());
        ...
        if (showHull)
        {
            _hullLayerIndex = viewerControl.AddPolygonConvexHullTwoLayer(
                "Convex Hull",
                LeftPolygon,
                RightPolygon,
                HullStyle());
            ...
            statusText.Text = _hullLayerIndex >= 0
