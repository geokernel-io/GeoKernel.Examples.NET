...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        toolbarPanel.Controls.AddRange(new Control[] { addButton, panButton, clearButton, fullExtentButton, toolStateLabel });
        ...
        addButton.BackgroundImage = (Image)resources.GetObject("addButton.Image");
        addButton.BackgroundImageLayout = ImageLayout.Center;
        addButton.FlatStyle = FlatStyle.Flat;
        addButton.FlatAppearance.BorderSize = 0;
        addButton.TabStop = false;
        addButton.AccessibleName = "Select Add";
        toolbarToolTip.SetToolTip(addButton, "Select Add");
        ...
        clearButton.BackgroundImage = (Image)resources.GetObject("clearButton.Image");
        ...
        toolStateLabel.Size = new Size(290, 22);
        toolStateLabel.Text = "API: clearSelectedFeatures / selectedFeatureCount";
        // 
        // splitContainer
        // 
