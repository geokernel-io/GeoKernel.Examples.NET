...
partial class MainForm
{
    ...
    private Button runIntersectionButton;
    ...
    private void InitializeComponent()
    {
        ...
        runIntersectionButton = new Button();
        ...
        toolbarPanel.Controls.AddRange(new Control[] { fullExtentButton, operationLabel, runIntersectionButton });
        ...
        operationLabel.Size = new Size(198, 22);
        operationLabel.Text = "Operation: Intersection(left, right)";
        // 
        // runIntersectionButton
        // 
        runIntersectionButton.Name = "runIntersectionButton";
        runIntersectionButton.AutoSize = true;
        runIntersectionButton.Height = 28;
        runIntersectionButton.Margin = new Padding(0, 2, 4, 2);
        runIntersectionButton.Padding = new Padding(8, 0, 8, 0);
        runIntersectionButton.UseVisualStyleBackColor = true;
        runIntersectionButton.Size = new Size(100, 22);
        runIntersectionButton.Text = "Run Intersection";
        runIntersectionButton.Click += runIntersectionButton_Click;
        // 
        // splitContainer
        // 
