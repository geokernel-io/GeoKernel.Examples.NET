...
public sealed partial class MainForm : Form
{
    ...
    private async void MainForm_Shown(object sender, EventArgs e)
    {
        ...
        if (!geoKernelViewerControl.AddLayerFile(path, new GeoKernelLayerLoadOptions
            {
                ...
                {
                    FillColor = "#D8E5E1", FillOpacity = 210,
                    LineColor = "#6F8883", LineWidth = 0.7
                }
            }))
        {
            SetProgress("World layer could not be loaded.", 0);
            MessageBox.Show(this, $"Layer could not be loaded:{Environment.NewLine}{path}",
                "InMemoryLayers", MessageBoxButtons.OK, MessageBoxIcon.Error);
            return;
        }
        ...
        SetProgress("Memory layers created.", 100);
