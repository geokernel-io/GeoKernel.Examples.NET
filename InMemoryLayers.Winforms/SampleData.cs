...
internal static class SampleData
{
    ...
    public static async Task<string> EnsureWorldLayerAsync(IWin32Window owner, IProgress<SampleDataProgress>? progress = null)
    {
        ...
        catch (Exception exception)
        {
            ...
            MessageBox.Show(owner, $"Sample data could not be prepared.{Environment.NewLine}{Environment.NewLine}{exception.Message}", "InMemoryLayers", MessageBoxButtons.OK, MessageBoxIcon.Error);
            return string.Empty;
        }
    }
